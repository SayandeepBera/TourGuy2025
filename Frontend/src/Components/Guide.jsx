            ...
            <div className="max-w-8xl mx-auto px-6 sm:px-10 lg:px-20">
                <div className="flex flex-col lg:flex-row items-center justify-between">
                    <div className="lg:w-2/3 text-center lg:text-left mb-8 lg:mb-0 p-5">
                        <h2 className="text-[1.65rem] md:text-[2rem] lg:text-[2.45rem] font-extrabold text-white mb-2">Ready to Lead? Join the <span>TourGuy</span> Guide Network.</h2>
                        <p className="text-base md:text-lg lg:text-[22px] text-gray-400 max-w-3xl">Apply today to manage your bookings, set your rates, and lead verified, safe tours in your area.</p>
                    </div>
